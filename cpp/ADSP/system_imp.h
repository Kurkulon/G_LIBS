...
static void Init_Cache()
{
	...
	if (l1_code_cache != 0)
	{
		...
		byte n = 0;
		HW::L1IM->Icplb_addr[n] = 0x11A00000; HW::L1IM->Icplb_data[n++] = L1IM_PSIZE_16KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;	// L1 Code SRAM (16 KB)
		HW::L1IM->Icplb_addr[n] = 0x11A04000; HW::L1IM->Icplb_data[n++] = L1IM_PSIZE_16KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;	// L1 Code SRAM (16 KB)
		HW::L1IM->Icplb_addr[n] = 0x11A08000; HW::L1IM->Icplb_data[n++] = L1IM_PSIZE_16KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;	// L1 Code SRAM (16 KB)
