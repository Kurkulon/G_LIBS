...
#ifndef INIT_L2CTL_CTL
#define INIT_L2CTL_CTL L2CTL_BK0EDIS|L2CTL_BK1EDIS|L2CTL_BK2EDIS|L2CTL_BK3EDIS|L2CTL_BK4EDIS|L2CTL_BK5EDIS|L2CTL_BK6EDIS|L2CTL_BK7EDIS
#endif
...
void Core0_InitIVG(u32 IVG, void (*EVT)())
{
	if (IVG <= 15 && IVG != 11)
	{
		HW::ICU->Evt[IVG]	 = (void*)EVT;		// *(pEVT0 + IVG) = (void*)EVT;
...
void Core1_InitIVG(u32 IVG, void (*EVT)())
{
	if (IVG <= 15 && IVG != 11)
	{
		HW::ICU->Evt[IVG]	 = (void*)EVT;		// *(pEVT0 + IVG) = (void*)EVT;
...
void InitSEC(u32 PID, void (*EVT)(), byte coren, byte prio)
{
	if (PID < PARAM_SEC0_SCOUNT)
	{
		u32 adr = ((u32)EVT) & 0xFFF00000;

		coren &= 1;

		if (adr == MEM_C0_BASE_L1IM)
		{
			coren = 0;
		}
		else if (adr == MEM_C1_BASE_L1IM)
		{
			coren = 1;
		};
		
		csync(); ssync();
		flushinv(SEC_VecTable+PID);
		csync(); ssync();
		flushinv(SEC_VecTable+PID);
		csync(); ssync();
		...
		HW::SEC->SSI[PID].SCTL	= SEC_IEN|SEC_SEN|SEC_CTG(coren)|SEC_PRIO(prio);
...
static void Init_Cache()
{
	...
	asm (	".extern ldf_L2_Cached_Adr;\n	.type ldf_L2_Cached_Adr, STT_OBJECT;\n		%0L = LO(ldf_L2_Cached_Adr	);	%0H = HI(ldf_L2_Cached_Adr	);"	: "=d" (L2_Cached_Adr)	: : );
	asm (	".extern ldf_L2_Cached_Len;\n	.type ldf_L2_Cached_Len, STT_OBJECT;\n		%0L = LO(ldf_L2_Cached_Len	);	%0H = HI(ldf_L2_Cached_Len	);"	: "=d" (L2_Cached_Len)	: : );
	...
	if (core0_code_cache != 0)
	{
		...
		byte n = 0;
		HW::L1IM->CPLB_ADDR[n] = 0xFFA00000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // CORE0 L1 Code SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC8080000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_L1CACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC8090000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_L1CACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC80A0000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_L1CACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC80B0000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_L1CACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // L2 SRAM (64 KB)
	...
	else
	{
		...
		byte n = 0;
		HW::L1IM->CPLB_ADDR[n] = 0xFFA00000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // CORE0 L1 Code SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xFFA10000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_16KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // CORE0 L1 Code SRAM (16 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC8080000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC8090000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC80A0000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC80B0000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID; // L2 SRAM (64 KB)
	...
	if (core0_data_cache_a != 0 || core0_data_cache_b != 0)
	{
		...
		u32 adr = L2_Cached_Adr;//MEM_BASE_L2_SRAM;
		u32 pageSize = 0;
		u32 dcplb = 0;
	...
	else
	{
		...
		const u32 DCPLB_L2_ASRAM	= L1DM_PSIZE_64MB	| L1DM_NOCACHE	| L1DM_DIRTY | L1DM_SWRITE | L1DM_UWRITE |	L1DM_UREAD | L1DM_LOCK | L1DM_VALID;
		const u32 DCPLB_L2_SRAM	= L1DM_PSIZE_1MB	| L1DM_NOCACHE	| L1DM_DIRTY | L1DM_SWRITE | L1DM_UWRITE |	L1DM_UREAD | L1DM_LOCK | L1DM_VALID;
		const u32 DCPLB_L1_SRAM	= L1DM_PSIZE_64KB	| L1DM_NOCACHE	| L1DM_DIRTY | L1DM_SWRITE | L1DM_UWRITE |	L1DM_UREAD | L1DM_LOCK | L1DM_VALID;

		byte n = 0;

		HW::L1DM->CPLB_ADDR[n] = 0xFF800000; HW::L1DM->CPLB_DATA[n++] = DCPLB_L1_SRAM;		// L1 Data Block A SRAM (32 KB)
		//HW::L1DM->CPLB_ADDR[n] = 0xFF804000, HW::L1DM->CPLB_DATA[n++] = DCPLB_L1_SRAM;	// L1 Data Block A SRAM/Cache (16 KB)
		HW::L1DM->CPLB_ADDR[n] = 0xFF900000; HW::L1DM->CPLB_DATA[n++] = DCPLB_L1_SRAM;		// L1 Data Block B SRAM (32 KB)
		//HW::L1DM->CPLB_ADDR[n] = 0xFF904000, HW::L1DM->CPLB_DATA[n++] = DCPLB_L1_SRAM;	// L1 Data Block B SRAM/Cache (16 KB)
		...
		HW::L1DM->CPLB_ADDR[n] = 0xC8080000; HW::L1DM->CPLB_DATA[n++] = DCPLB_L2_SRAM;		// L2 SRAM (256 KB)
		//HW::L1DM->CPLB_ADDR[n] = 0xC8090000; HW::L1DM->CPLB_DATA[n++] = DCPLB_L2_SRAM;	// L2 SRAM (64 KB)
		//HW::L1DM->CPLB_ADDR[n] = 0xC80A0000; HW::L1DM->CPLB_DATA[n++] = DCPLB_L2_SRAM;	// L2 SRAM (64 KB)
		//HW::L1DM->CPLB_ADDR[n] = 0xC80B0000; HW::L1DM->CPLB_DATA[n++] = DCPLB_L2_SRAM;	// L2 SRAM (64 KB)
...
static void Core1_Init_Cache()
{
	...
	if (core1_code_cache != 0)
	{
		...
		byte n = 0;
		HW::L1IM->CPLB_ADDR[n] = 0xFF600000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID|L1IM_L1SRAM;	// CORE1 L1 Code SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC8080000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_L1CACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;				// L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC8090000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_L1CACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;				// L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC80A0000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_L1CACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;				// L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC80B0000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_L1CACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;				// L2 SRAM (64 KB)
	...
	else
	{
		...
		byte n = 0;
		HW::L1IM->CPLB_ADDR[n] = 0xFF600000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID|L1IM_L1SRAM;	// CORE1 L1 Code SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xFF610000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_16KB |L1IM_NOCACHE|L1IM_CPRIO_LO|L1IM_UREAD|L1IM_LOCK|L1IM_VALID|L1IM_L1SRAM;	// CORE1 L1 Code SRAM (16 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC8080000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;				// L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC8090000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;				// L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC80A0000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;				// L2 SRAM (64 KB)
		HW::L1IM->CPLB_ADDR[n] = 0xC80B0000; HW::L1IM->CPLB_DATA[n++] = L1IM_PSIZE_64KB |L1IM_NOCACHE|L1IM_CPRIO_HI|L1IM_UREAD|L1IM_LOCK|L1IM_VALID;				// L2 SRAM (64 KB)
	...
	else
	{
		...
		const u32 DCPLB_L2_ASRAM	= L1DM_PSIZE_64MB	| L1DM_NOCACHE	| L1DM_DIRTY | L1DM_SWRITE | L1DM_UWRITE |	L1DM_UREAD | L1DM_LOCK | L1DM_VALID;
		const u32 DCPLB_L2_SRAM	= L1DM_PSIZE_1MB	| L1DM_NOCACHE	| L1DM_DIRTY | L1DM_SWRITE | L1DM_UWRITE |	L1DM_UREAD | L1DM_LOCK | L1DM_VALID;
		const u32 DCPLB_L1_SRAM	= L1DM_PSIZE_64KB	| L1DM_NOCACHE	| L1DM_DIRTY | L1DM_SWRITE | L1DM_UWRITE |	L1DM_UREAD | L1DM_LOCK | L1DM_VALID | L1DM_L1SRAM;

		byte n = 0;

		HW::L1DM->CPLB_ADDR[n] = 0xFF400000; HW::L1DM->CPLB_DATA[n++] = DCPLB_L1_SRAM;		// L1 Data Block A SRAM (32 KB)
		//HW::L1DM->CPLB_ADDR[n] = 0xFF404000, HW::L1DM->CPLB_DATA[n++] = DCPLB_L1_SRAM;		// L1 Data Block A SRAM/Cache (16 KB)
		HW::L1DM->CPLB_ADDR[n] = 0xFF500000; HW::L1DM->CPLB_DATA[n++] = DCPLB_L1_SRAM;		// L1 Data Block B SRAM (32 KB)
		//HW::L1DM->CPLB_ADDR[n] = 0xFF504000, HW::L1DM->CPLB_DATA[n++] = DCPLB_L1_SRAM;		// L1 Data Block B SRAM/Cache (16 KB)
...
extern "C" void SystemInit()
{
	...
	HW::PIOB->MUX		= INIT_PORTB_MUX;	
	HW::PIOC->MUX		= INIT_PORTC_MUX;	
	HW::PIOD->MUX		= INIT_PORTD_MUX;	
	HW::PIOE->MUX		= INIT_PORTE_MUX;	
	HW::PIOF->MUX		= INIT_PORTF_MUX;	
	HW::PIOG->MUX		= INIT_PORTG_MUX;	

	HW::PIOA->FER 		= INIT_PORTA_FER;	
	HW::PIOB->FER 		= INIT_PORTB_FER;	
	HW::PIOC->FER 		= INIT_PORTC_FER;	
	HW::PIOD->FER		= INIT_PORTD_FER;	
	HW::PIOE->FER		= INIT_PORTE_FER;	
	HW::PIOF->FER		= INIT_PORTF_FER;	
	HW::PIOG->FER		= INIT_PORTG_FER;	

	HW::PIOA->DIR 		= INIT_PORTA_DIR;		
	HW::PIOB->DIR 		= INIT_PORTB_DIR;		
	HW::PIOC->DIR 		= INIT_PORTC_DIR;		
	HW::PIOD->DIR		= INIT_PORTD_DIR;	
	HW::PIOE->DIR		= INIT_PORTE_DIR;	
	HW::PIOF->DIR		= INIT_PORTF_DIR;	
	HW::PIOG->DIR		= INIT_PORTG_DIR;	

	HW::PIOA->INEN 		= INIT_PORTA_INEN;	
	HW::PIOB->INEN 		= INIT_PORTB_INEN;	
	HW::PIOC->INEN 		= INIT_PORTC_INEN;	
	HW::PIOD->INEN		= INIT_PORTD_INEN;	
	HW::PIOE->INEN		= INIT_PORTE_INEN;	
	HW::PIOF->INEN		= INIT_PORTF_INEN;	
	HW::PIOG->INEN		= INIT_PORTG_INEN;	

	HW::PIOA->DATA		= INIT_PORTA_DATA;
	HW::PIOB->DATA		= INIT_PORTB_DATA;
	HW::PIOC->DATA		= INIT_PORTC_DATA;
	HW::PIOD->DATA		= INIT_PORTD_DATA;	
	HW::PIOE->DATA		= INIT_PORTE_DATA;	
	HW::PIOF->DATA		= INIT_PORTF_DATA;	
	HW::PIOG->DATA		= INIT_PORTG_DATA;	
	...
	HW::PADS->EMAC_PTP_CLKSEL	= 0;
	HW::PADS->PORTS_HYST		= 0;
	HW::PADS->TWI_VSEL			= 0;
