...
//	dword			_preReadTimeout;
  ...
  public:
	...
	ComPort(byte num, T_HW::S_PORT* psck, T_HW::S_PORT* ptx, T_HW::S_PORT* prx, T_HW::S_PORT* prts, byte pinsck, byte pintx, byte pinrx, byte pinrts, byte muxsck, byte muxtx, u32 dx0cr, u32 dx1cr, byte dmach, byte drl)
		...
		_DMA(dmach), _DRL(drl), _DX0CR(dx0cr), _DX1CR(dx1cr), _connected(false), _status485(READ_END) {}
